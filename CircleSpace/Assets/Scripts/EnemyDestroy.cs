...
public class EnemyDestroy : MonoBehaviour
{
    ...
    [SerializeField] private GameObject bgCirclePrefab;
    private GameObject backgroundParent;
    [SerializeField] GameObject plus10PointsPrefab;
    ...
    private void EnemyHit()
    {
        switch(enemyState)
        {
            ...
            case 1:
                ...
                GameObject newCircle = Instantiate(bgCirclePrefab, transform.position, transform.rotation); // Make new circle where this enemy died
                newCircle.transform.SetParent(backgroundParent.transform);

                GameObject plus10 = Instantiate(plus10PointsPrefab, transform.position, transform.rotation);
